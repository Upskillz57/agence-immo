  ...
  return (
    <div className={`${montserrat.className} min-h-screen bg-[#f5f5f5]`}>
      ...
      <main className="max-w-4xl mx-auto px-6 py-14">
        ...
        <p className="text-sm text-gray-400 mb-10">Gérez votre agence immobilière</p>
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">Associer une vidéo à un bien et définir l'ordre des réels</p>
            </div>
          ...
          >
            ...
            <div>
              <h2 className="text-base font-semibold text-[#122e53]">Gérer l'équipe</h2>
              <p className="text-sm text-gray-400 mt-1">Modifier les conseillers, photos, contacts</p>
            </div>
            <span className="ml-auto text-gray-300 text-xl">→</span>
          </div>
