...
export default function ConseillersPage() {
  ...
  return (
    <main className="bg-white">
      ...
      {/* HERO */}
      <section className="relative h-[420px] w-full flex items-center justify-center">
        <Image
          src="/conseillers.jpg"
          alt="Nos conseillers"
          fill
        ...
        <div className="relative text-center text-white">
          ...
          <p className="mt-4 text-sm md:text-base tracking-[3px] uppercase text-[#d4af37]">
      ...
      <section className="max-w-7xl mx-auto px-8 py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {advisors.map((advisor, index) => (
            <div
              key={index}
              className="group bg-white shadow-sm hover:shadow-xl transition duration-500"
            >
              ...
              <div className="p-6 text-center">
                <h3 className="text-lg font-semibold text-[#122e53]">
                  {advisor.name}
                </h3>
                ...
                <div className="mt-6 space-y-2 text-sm text-gray-600">
                  ...
                  <button
                    ...
                    className="block w-full hover:text-[#122e53] transition"
                  >
                    Envoyer un e-mail
                  </button>
                </div>
